            ...
            >
              <div className="p-8">
                ...
                <div className="mt-8 flex justify-center space-x-6">
                  <Link href={dev.linkedinUrl} target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:text-blue-400 transition-colors duration-200">
                    <Linkedin className="h-8 w-8" />
                  </Link>
                  <Link href={dev.githubUrl} target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:text-blue-400 transition-colors duration-200">
                    <Github className="h-8 w-8" />
                  </Link>
                  <Link href={`mailto:${dev.email}`} className="text-blue-500 hover:text-blue-400 transition-colors duration-200">
                ...
                <div className="mt-8 pt-6 border-t border-gray-700 text-center">
                  ...
                  {/* Add more details here if needed, e.g., phone, personal website */}
                </div>
              </div>
            </div>
          ))}
